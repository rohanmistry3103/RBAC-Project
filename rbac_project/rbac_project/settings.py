...
SECRET_KEY = "django-insecure-xr1ur)#yablxo+e+!e@ouxx-)j*0y@th1%qqx=jwzmv+tr39=g"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'rbac_database',  # Replace 'your_database_name' with the name of your PostgreSQL database
